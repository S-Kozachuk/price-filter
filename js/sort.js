...
Если возращается положительное число, (знак +), нужно изменить порядок (индекс).
...
/*
Если нужно реализовать какую-либо нестандартную сортировку, то
...
// Unsorting array
/*
В этом примере сортировка основана на сравнении значений указанных свойств.
В результате меняется порядок объектов (в которых находятся сравниваемые свойства).
*/
console.log(arr2);

arr3 = arr2.slice().sort(function(a, b) {
	return a.one - b.one;
});
